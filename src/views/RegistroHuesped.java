...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuespedes() {
		String DateBirth = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		Huespedes nuevoHuesped = new Huespedes(
				txtNombre.getText(),
				txtApellido.getText(),
				java.sql.Date.valueOf(DateBirth),
				txtNacionalidad.getSelectedItem().toString(),
				txtTelefono.getText(),
				Integer.valueOf(txtNreserva.getText()));
		huespedesController.guardar(nuevoHuesped);
		JOptionPane.showMessageDialog(contentPane, "El huesped se guardo de manera exitosa, id: " + nuevoHuesped.getId());
		dispose();
	}
