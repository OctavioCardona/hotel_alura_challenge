...
public class Busqueda extends JFrame {
	...
	private void LlenarTablaReservas() {
		...
		try {
			for(Reservas reserva : reservas) {
				modelo.addRow(new Object[] {reserva.getId(), reserva.getDateIn(), reserva.getDateOut(),
	...
	private void LlenarTablaReservasId() {
		...
		List<Reservas> reservas = buscarReservasId();
		try {
			for(Reservas reserva : reservas) {
				modelo.addRow(new Object[] {reserva.getId(), reserva.getDateIn(), reserva.getDateOut(),
						reserva.getValor(), reserva.getFormaPago() });
	...
	private void LlenarTablaHuespedes() {
		...
		try {
			for(Huespedes huesped : huespedes) {
				modeloHuesped.addRow(new Object[] {huesped.getId(), huesped.getNombre(), huesped.getApellido(), huesped.getFechaNacimiento(),
	...
	private  List<Huespedes> buscarHuespedesId(){
		return this.huespedesController.buscarHuespedesId(txtBuscar.getText());
	}
	...
	private void eliminar() {
		...
		if (filaReservas >= 0) {
            ...
            JOptionPane.showMessageDialog(this,"Reserva y huesped eliminados con éxito!");
		} else if(filaHuespedes >= 0) {
	...
	public void actualizarReservas(){
        ...
        .ifPresentOrElse(fila -> {
            ...
            this.reservasController.modificar(fechaEntrada, fechaSalida, valor, formaPago,id);
           
            JOptionPane.showMessageDialog(this, "El registro fue acutalizado correctamente");
	...
	public void actualizarHuespedes(){
        ...
        .ifPresentOrElse(fila -> {
            ...
            this.huespedesController.modificar(nombre, apellido, fechaNacimiento, nacionalidad, telefono, idReservas, id);
